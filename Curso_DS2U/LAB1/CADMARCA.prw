...
Static Function MenuDef()
	...
	ADD OPTION alRotina TITLE "Visualizar"	ACTION "VIEWDEF.CADMOD3"	OPERATION 2 ACCESS 0 // "Visualizar"
	ADD OPTION alRotina TITLE "Incluir"		ACTION "VIEWDEF.CADMOD3"	OPERATION 3 ACCESS 0 // "Incluir"
	ADD OPTION alRotina TITLE "Alterar"		ACTION "VIEWDEF.CADMOD3"	OPERATION 4 ACCESS 0 // "Alterar"
	ADD OPTION alRotina TITLE "Excluir"		ACTION "VIEWDEF.CADMOD3"	OPERATION 5 ACCESS 0 // "Excluir" 
...
Static Function ModelDef()
	...
	local olModel
	local alRelation := {}
	local oStruZA0	:= FWFormStruct( 1, 'ZA0', /*{ |x|  }*/, /*lViewUsado*/ )
	local oStruZA1	:= FWFormStruct( 1, 'ZA1', /*bAvalCampo*/, /*lViewUsado*/ )
	
	//-- Cria a estrutura basica	
	olModel := MPFormModel():New('CADMOD3M', /* bPreValidacao*/,/*bPosValidacao*/, /*bCommit*/, /*bCancel*/ )
...
Static Function ViewDef()
	...
	local olModel    := FWLoadModel( 'CADMARCA' )
	local olView
