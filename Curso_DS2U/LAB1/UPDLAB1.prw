...
/*/
//--------------------------------------------------------------------
User Function UPDLAB1( cEmpAmb, cFilAmb )
...
If lOk
	...
	If !Empty( aMarcadas )
		If lAuto .OR. MsgNoYes( "Confirma a atualização dos dicionários ?", cTitulo )
			...
			If lAuto
				If lOk
					MsgStop( "Atualização Realizada.", "UPDLAB1" )
				Else
					MsgStop( "Atualização não Realizada.", "UPDLAB1" )
				EndIf
				dbCloseAll()
			Else
				If lOk
...
aAdd( aSX2, { ;
	...
	'Marcas de Carro'														, ; //X2_NOME
	'Marcas de Carro'														, ; //X2_NOMESPA
	'Marcas de Carro'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Modelos de Carro'														, ; //X2_NOME
	'Modelos de Carro'														, ; //X2_NOMESPA
	'Modelos de Carro'														, ; //X2_NOMEENG
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX2, { ;
	...
	'Lançamentos do Estacionamento'											, ; //X2_NOME
	'Lançamentos do Estacionamento'											, ; //X2_NOMESPA
	'Lançamentos do Estacionamento'											, ; //X2_NOMEENG
	'E'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
	''																		, ; //X2_PYME
...
aAdd( aSX3, { ;
	...
	"GETSXENUM('ZA0','ZA0_ID')"												, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	"GETSXENUM('ZA1','ZA1_ID')"												, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'R'																		, ; //X3_CONTEXT
	'x'																		, ; //X3_OBRIGAT
	"ExistCpo('ZA0', M->ZA1_IDMARC)"										, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Desc. Marca'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	"IIF(!INCLUI,POSICIONE('ZA0',1,FWXFILIAL('ZA0')+ZA1->ZA1_IDMARC,'ZA0_DESC'),'')", ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	"POSICIONE('ZA0',1,FWXFILIAL('ZA0')+ZA1->ZA1_IDMARC,'ZA0_DESC')"		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	"GETSXENUM('ZA2','ZA2_ID')"												, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'ID Modelo'																, ; //X3_TITSPA
	'ID Modelo'																, ; //X3_TITENG
	'ID Modelo'																, ; //X3_DESCRIC
	'ID Modelo'																, ; //X3_DESCSPA
	'ID Modelo'																, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	"GETSXENUM('ZA2','ZA2_ID')"												, ; //X3_RELACAO
	...
	'R'																		, ; //X3_CONTEXT
	'x'																		, ; //X3_OBRIGAT
	"ExistCpo('ZA1',M->ZA2_IDMODE)"											, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
...
aAdd( aSX3, { ;
	...
	'Desc. Modelo'															, ; //X3_DESCRIC
	'Desc. Modelo'															, ; //X3_DESCSPA
	'Desc. Modelo'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	"IIF(!INCLUI,POSICIONE('ZA1',1,FWXFILIAL('ZA1')+ZA2->ZA2_IDMODE,'ZA1_DESC'),'')", ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	'xxxxxx x'																, ; //X3_RESERV
	''																		, ; //X3_CHECK
	...
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	"POSICIONE('ZA1',1,FWXFILIAL('ZA1')+ZA2->ZA2_IDMODE,'ZA1_DESC')"		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	''																		, ; //X3_FOLDER
	''																		, ; //X3_CONDSQL
	''																		, ; //X3_CHKSQL
...
aAdd( aSX3, { ;
	...
	'Data de Entrada'														, ; //X3_DESCRIC
	'Data de Entrada'														, ; //X3_DESCSPA
	'Data de Entrada'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'DATE()'																, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Hr. Entrada'															, ; //X3_TITULO
	'Hr. Entrada'															, ; //X3_TITSPA
	'Hr. Entrada'															, ; //X3_TITENG
	'Hora de Entrada'														, ; //X3_DESCRIC
	'Hora de Entrada'														, ; //X3_DESCSPA
	'Hora de Entrada'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	'TIME()'																, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Dt. Saída'																, ; //X3_TITSPA
	'Dt. Saída'																, ; //X3_TITENG
	'Data de Saída'															, ; //X3_DESCRIC
	'Data de Saída'															, ; //X3_DESCSPA
	'Data de Saída'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'Hr. Saída'																, ; //X3_TITSPA
	'Hr. Saída'																, ; //X3_TITENG
	'Hora de Saída'															, ; //X3_DESCRIC
	'Hora de Saída'															, ; //X3_DESCSPA
	'Hora de Saída'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	'x       x       x       x       x       x       x       x       x       x       x       x       x       x       x x', ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX7, { ;
	'ZA1_IDMARC'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ZA0->ZA0_DESC'															, ; //X7_REGRA
	'ZA1_DESMAR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'ZA0'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	"FWXFILIAL('ZA0')+M->ZA1_IDMARC"										, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'ZA2_IDMODE'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'ZA1->ZA1_DESC'															, ; //X7_REGRA
	'ZA2_DESMOD'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'ZA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	"FWXFILIAL('ZA1')+M->ZA2_IDMODE"										, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'ZA2_IDMODE'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	"POSICIONE('ZA0',1,FWXFILIAL('ZA0')+ZA1->ZA1_IDMARC,'ZA0_DESC')"		, ; //X7_REGRA
	'ZA2_DESMAR'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	'ZA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Marcas de Carro'														, ; //XB_DESCRI
	'Marcas de Carro'														, ; //XB_DESCSPA
	'Marcas de Carro'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZA0'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'01'																	, ; //XB_SEQ
	'DB'																	, ; //XB_COLUNA
	'Modelos de Carro'														, ; //XB_DESCRI
	'Modelos de Carro'														, ; //XB_DESCSPA
	'Modelos de Carro'														, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	'ZA1'																	} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'Marca'																	, ; //XB_DESCENG
	''																		, ; //XB_WCONTEM
	"POSICIONE('ZA0',1,FWXFILIAL('ZA0')+ZA1->ZA1_IDMARC,'ZA0_DESC')"		} ) //XB_CONTEM
...
@ 112, 157  Button oButOk   Prompt "Processar"  Size 32, 12 Pixel Action (  RetSelecao( @aRet, aVetor ), IIf( Len( aRet ) > 0, oDlg:End(), MsgStop( "Ao menos um grupo deve ser selecionado", "UPDLAB1" ) ) ) ;
